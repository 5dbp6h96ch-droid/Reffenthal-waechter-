/*
 * R(h)einschiffer – echte Design-Testversion
 * -------------------------------------------
 * VISUAL-ONLY CHANGE:
 * - vorhandene Pegeldaten und API-Aufrufe bleiben erhalten
 * - 7 Tage / 30 Tage / 3 Monate bleiben erhalten
 * - bestehende Vorhersage/GIF-Logik bleibt erhalten
 * - bestehende RheinKarte bleibt erhalten
 * - News / Clubs / Tankstelle / NfB / Wächter-Logik bleiben erhalten
 * - keine neue Datenquelle und keine neue Pegelberechnung
 *
 * Diese Datei ist eine Testkopie. Die originale index.tsx wird nicht überschrieben.
 */
