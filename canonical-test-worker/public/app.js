...
const knownRoutes=new Set(['pegel','start','vorhersage','nfb','tankstelle','clubs','rhein-karte','news','waechter','konto','hilfe','einstellungen','passwort-vergessen','passwort-zuruecksetzen']);
if(!location.hash||!knownRoutes.has(initialRoute))history.replaceState(null,'',`${location.pathname}${location.search}#/pegel`);
